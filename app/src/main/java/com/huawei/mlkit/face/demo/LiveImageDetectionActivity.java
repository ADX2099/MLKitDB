...
public class LiveImageDetectionActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, FaceAnalyzerTransactor.AssignationModel {
    ...
    @Override
    public void successAssignation(FaceModel model) {


        Intent theIntent = new Intent(LiveImageDetectionActivity.this,SavingActivity.class);
        theIntent.putExtra(FaceConstants.FACE, (Parcelable) model);
